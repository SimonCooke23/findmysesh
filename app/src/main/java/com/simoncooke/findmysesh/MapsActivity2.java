    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.B_pubs:
                ...
                Toast.makeText(MapsActivity2.this, "Showing Nearby Pubs", Toast.LENGTH_LONG).show();
                break;
            ...
            case R.id.B_clubs:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby Clubs", Toast.LENGTH_LONG).show();
                break;
